...
def display_results(image_paths, probs):
  '''Displays the classification results given the class probability for each
  image'''
...
def main():
  ...
  parser.add_argument('model_path',
                      help='Converted parameters for the GoogleNet model')
  parser.add_argument('image_paths', nargs='+',
                      help='One or more images to classify')
